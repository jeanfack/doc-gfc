...
::::{grid}
:::{grid-item-card}
How can Meg share the filtered view of issues assigned to Brian on GitHub ?
:::

:::{grid-item-card}
By copying the URL generated by GitHub for the filtered view and sending it to Brian.
:::
